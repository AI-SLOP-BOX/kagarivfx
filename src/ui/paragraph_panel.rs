...
pub fn draw_paragraph_panel(app: &mut AfterEffectsApp, ui: &mut egui::Ui) {
    ...
    if !matches!(layer.layer_type, crate::core::timeline::LayerType::Text { .. }) {
        ui.label(egui::RichText::new("Selected layer is not a text layer.").small().color(colors::TEXT_MUTED));
        return;
    }
    ...
    ui.label(egui::RichText::new("Alignment").small().color(colors::TEXT_SECONDARY));
    ui.horizontal(|ui| {
        let aligns = [
            (TextAlign::Left, "Left"),
    ...
    ui.horizontal(|ui| {
        ui.label(egui::RichText::new("Width").small().color(colors::TEXT_SECONDARY));
        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
            ui.label(egui::RichText::new("px").small().color(colors::TEXT_MUTED));
            if ui.add(egui::DragValue::new(&mut fmt.box_width).speed(1.0).range(0.0..=10000.0)).changed() {
                changed = true;
            }
        });
    });
    ui.horizontal(|ui| {
        ui.label(egui::RichText::new("Height").small().color(colors::TEXT_SECONDARY));
        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
            ui.label(egui::RichText::new("px").small().color(colors::TEXT_MUTED));
            if ui.add(egui::DragValue::new(&mut fmt.box_height).speed(1.0).range(0.0..=10000.0)).changed() {
                changed = true;
            }
        });
    });
    ...
    ui.horizontal(|ui| {
        ui.label(egui::RichText::new("Tracking").small().color(colors::TEXT_SECONDARY));
        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
            ui.label(egui::RichText::new("px").small().color(colors::TEXT_MUTED));
            if ui.add(egui::DragValue::new(&mut fmt.tracking).speed(0.1).range(-100.0..=1000.0)).changed() {
                changed = true;
            }
        });
    });
    ui.horizontal(|ui| {
        ui.label(egui::RichText::new("Leading").small().color(colors::TEXT_SECONDARY));
        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
            if ui.add(egui::DragValue::new(&mut fmt.leading).speed(0.01).range(0.1..=10.0)).changed() {
                changed = true;
            }
        });
    });
    ...
    ui.horizontal(|ui| {
        ui.label(egui::RichText::new("Enabled").small().color(colors::TEXT_SECONDARY));
    ...
    if let Some(ref mut stroke_color) = fmt.stroke_color {
        ui.horizontal(|ui| {
            ...
            ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                ui.label(egui::RichText::new("px").small().color(colors::TEXT_MUTED));
                if ui.add(egui::DragValue::new(&mut fmt.stroke_width).speed(0.1).range(0.0..=100.0)).changed() {
                    changed = true;
                }
            });
        });
        ...
        ui.horizontal(|ui| {
            ...
            ui.painter().rect_filled(swatch_rect, 2.0, egui::Color32::from_rgba_premultiplied(r, g, b, a));
            ui.painter().rect_stroke(swatch_rect, 2.0, egui::Stroke::new(1.0, colors::BORDER_MEDIUM));

            if ui.add(egui::DragValue::new(&mut stroke_color[0]).speed(0.01).range(0.0..=1.0).prefix("R ")).changed() {
                changed = true;
            }
            if ui.add(egui::DragValue::new(&mut stroke_color[1]).speed(0.01).range(0.0..=1.0).prefix("G ")).changed() {
                changed = true;
            }
            if ui.add(egui::DragValue::new(&mut stroke_color[2]).speed(0.01).range(0.0..=1.0).prefix("B ")).changed() {
                changed = true;
            }
        });
    }
