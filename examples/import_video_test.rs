...
use aftereffects_oss::core::video_import::{frame_path, import_video};
...
fn main() {
    ...
    let f0 = aftereffects_oss::core::software_renderer::render_frame_to_pixels(
        &comp, 2, 160, 120, 0.0, 0,
    );
    let f1 = aftereffects_oss::core::software_renderer::render_frame_to_pixels(
